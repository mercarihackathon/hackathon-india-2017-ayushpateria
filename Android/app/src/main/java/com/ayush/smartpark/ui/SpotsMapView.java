...
public class SpotsMapView  extends BaseActivity
    ...
    private static final String TAG = SpotsMapView.class.getSimpleName();
    ...
    public void onMapReady(GoogleMap map) {
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(final Marker marker) {
                ...
                TextView title = ((TextView) infoWindow.findViewById(R.id.c_title));
                title.setText(marker.getTitle());



                TextView snippet = ((TextView) infoWindow.findViewById(R.id.c_address));
        ...
        getDeviceLocation();
        for (Spot.SpotItem item : Spot.ITEMS) {
            Marker marker = mMap.addMarker(new MarkerOptions()
                    .title(item.title + "   -   ₹" + item.cost)
                    .position(new LatLng(Float.parseFloat(item.lat), Float.parseFloat(item.lon)))
                    .snippet(item.addr));
            marker.setTag(item.id);
        }
        mMap.setOnMarkerClickListener(SpotsMapView.this);
    }
